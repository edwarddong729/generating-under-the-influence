...
from dataloaders import gen_warmup_all_styles_dataloader
...
def main():
    ...
    TRAIN_SAMPLES_PER_AUTHOR = 2048
    VAL_SAMPLES_PER_AUTHOR = 512
    MAX_EPOCHS = 80
    BATCH_SIZE = 32 # 64 too big to fit in memory
    LR = 1e-5
    ...
    train_dataloader, val_dataloader = gen_warmup_all_styles_dataloader(TRAIN_SAMPLES_PER_AUTHOR, VAL_SAMPLES_PER_AUTHOR, BATCH_SIZE)
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        with torch.no_grad():  # Disable gradient calculation during validation and sample generation
            ...
            if epoch_end_val_loss < best_loss:
                ...
                torch.save(generator.state_dict(), 'all_styles_generator_state_dict.pth')
        ...
        if epochs_since_improvement == 5:
            print('Stopping early because val loss did not improve in 5 epochs.')
            break
    ...
    plt.legend()
    plt.savefig('all_styles_gen_training.png')
    plt.clf()
